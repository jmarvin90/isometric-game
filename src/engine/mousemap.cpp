...
MouseMap::MouseMap(const std::string &mousemap_file_path) : mousemap{IMG_Load(mousemap_file_path.c_str())}
{
...
glm::ivec2 MouseMap::pixel_to_grid(const glm::ivec2 &pixel_coordinate) const
{
    ...
    {
        remainder_x = (constants::TILE_SIZE.x +
    ...
    {
        remainder_y = (constants::TILE_SIZE.y +
